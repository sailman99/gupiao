				...
				items:[{xtype:'button',
						...
						handler:function(){
			            	...
			            	for(var i=0;i<1000;i++){
			            		if(!Ext.isEmpty(Ext.getCmp('checkbox'+i.toString()))){
			            			 if(!Ext.getCmp('checkbox'+i.toString()).config.disabled){
			            				 var jsonobj={czydm:czydm601,swjgdm:Ext.getCmp('checkbox'+i.toString()).config.inputValue,swjgmc:Ext.getCmp('checkbox'+i.toString()).config.boxLabel,bz:Ext.getCmp('checkbox'+i.toString()).getValue()};
